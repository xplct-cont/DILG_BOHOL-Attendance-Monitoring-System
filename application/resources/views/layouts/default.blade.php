            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #234495;">
                <div class="container-fluid">
                    ...
                    <button type="button" id="slidesidebar" class="ui icon button bg-light text-dark bg-white" >
                        <i class="ui icon bars"></i> <span class="toggle-sidebar-menu text-dark">{{ __('Menu') }}</span>
                    </button>
                        ...
                        <ul class="nav navbar-nav ml-auto navmenu">
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    <i class="ui icon flag text-light"></i> <span class="navmenutext uppercase text-light">{{ env('APP_LOCALE', 'en') }}</span>
                                    <i class="dropdown icon text-light"></i>
                            ...
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    <i class="ui icon linkify text-light"></i> <span class="navmenutext uppercase text-light">{{ __('Quick Access') }}</span>
                                    <i class="dropdown icon text-light"></i>
                                    <div class="menu" tabindex="-1">
                                      <a href="{{ url('clock') }}" target="_blank" class="item"><i class="ui icon clock outline text-light"></i>{{ __('Clock In/Out') }}</a>
                            ...
                            <li class="nav-item">
                               <div class="ui pointing link dropdown item" tabindex="0">
                                    <i class="ui icon user outline text-light"></i> <span class="navmenutext text-light">@isset(Auth::user()->name){{ Auth::user()->name }}@endisset</span>
                                    <i class="dropdown icon text-light"></i>
                                    <div class="menu" tabindex="-1">
